...
public class CharacterMovement : MonoBehaviour {
    ...
    public ThirdPersonOrbit GetCamScript { get { return camScript; } }
    ...
    void Update () {
        ...
        h = player.leftHorizontal;
        v = player.rightVertical;
...
public abstract class GenericBehaviour : MonoBehaviour {
    ...
    protected CharacterMovement behaviourManager;     // Reference to the basic behaviour manager.
    protected int behaviourCode;                   // The code that identifies a behaviour.
   
    void Awake() {
        // Set up the references.
        behaviourManager = GetComponent<CharacterMovement>();
